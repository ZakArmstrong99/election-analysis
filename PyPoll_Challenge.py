...
# Name of county with highest turnout
county_name = ""
# Number of votes of county with highest turnout
county_votes = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in counties_dict:
        ...
        county_count = counties_dict.get(county_name)
        ...
        if (county_count > county_votes):
            county_votes = county_count
        else:
            county_total = 0
            county_total = len(counties_dict)
            county_list = list(counties_dict)
            county_name = county_list[county_total - 2]
